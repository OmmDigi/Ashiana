...
export default function page({ params }: IProps) {
  ...
  return (
    <EachServiceLayout
      blogheading="The Best Skylight Dome Designer in Kolkata"
      blogimage="/services/skyleight-dome-blog-banner.webp"
      faqs={faqs}
      servicesList={servicesList}
      servicename="skylight dome"
      topheading="The Best Skylight Dome Designer in Kolkata"
    ...
    >
      ...
      <GridImage images={["/services/skylight-dom-1.webp", "/services/skylight-dom-2.webp"]}/>
